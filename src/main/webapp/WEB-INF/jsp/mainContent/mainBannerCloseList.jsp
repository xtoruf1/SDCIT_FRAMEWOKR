				...
				<div class="tab_cont on">
					<div class="tit_bar">
						...
						<div class="btnGroup ml-auto">
							<%--<button type="button" id="btnAdd" class="btn_icon btn_add" onclick="addBanner();">추가</button>--%>
						</div>
					</div>
...
<script type="text/javaScript" language="javascript">
	...
	function getList(){
	   ...
	   global.ajax({
				type : 'POST'
				, url : '<c:url value="/mainContent/closeList.do" />'
	...
	function getBannerInfo(mainBannerId) {
		location.href = "/mainContent/mainBannerModify.do?mainBannerId="+mainBannerId;
	}
