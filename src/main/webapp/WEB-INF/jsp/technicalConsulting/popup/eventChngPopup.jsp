							...
							<tr>
								...
								<td>
									<span class="form_search w100p">
										<input type="text" name="searchKeyword" class="form_text w100p" value="" onkeydown="onEnter(doSearch2);">
									</span>
								</td>
							</tr>
						</tbody>
...
<script type="text/javascript">
	...
	function f_Init_tradeSearch() {
		...
		ibHeader.addHeader({Type: "Text", Header: "상담회명"		, SaveName: "cfrcName"	,  Align: "Left"		, Width: 200	,Edit : false	, Ellipsis:1, Cursor:"Pointer"});
		...
		createIBSheet2(container,sheetId, "100%", "350px");
	...
	function getList2(){
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/technicalConsulting/conferenceMaEventList.do" />'
			...
			, success : function(data){
				...
				$('#totalCnt2').html('총 <span>' + global.formatCurrency(data.resultCnt) + '</span> 건');
	...
	function tradeSearch_OnClick(Row, Col, Value) {
		if(tradeSearch.ColSaveName(Col) == "cfrcName" && Row > 0) {
