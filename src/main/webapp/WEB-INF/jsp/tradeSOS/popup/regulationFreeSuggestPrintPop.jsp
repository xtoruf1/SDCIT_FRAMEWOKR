...
<script type="text/javascript">
	...
	function f_Init_processingHistorySheetPrint()								//처리이력 목록
	{
		...
		ibHeader.addHeader({Type: "Text", Header: "상태"			, SaveName: "statusCdNm"	, Align: "Center"	, Width: 120	, Ellipsis:1});
		ibHeader.addHeader({Type: "Text", Header: "이력내용"		, SaveName: "hisText"		, Align: "Left"		, Width: 350	, ToolTip: true});
		ibHeader.addHeader({Type: "Text", Header: "소관부처/기관"	, SaveName: "conOrganm"		, Align: "Left"		, Width: 267});
