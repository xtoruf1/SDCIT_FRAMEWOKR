...
<div style="width: 1170px;height: 750px;" class="fixed_pop_tit">
	<div class="flex popup_top">
		<h2 class="popup_title">수출입 규제 건의 신청 대리입력</h2>
		<div class="ml-auto">
		...
		<form name="submitForm" id="submitForm" method="post" enctype="multipart/form-data" >
			...
			<table class="formTable">
				...
				<tr>
					...
					<td>
						<div class="flex align_center">
							...
							<input type="text" id="compPhone" name="compPhone" maxlength="20" class="form_text w100p"/>
						</div>
					</td>
					<th scope="row">FAX</th>
					<td>
						<div class="flex align_center">
							<input type="text" id="compFax" name="compFax" maxlength="20" class="form_text w100p"/>
				...
				<tr>
					...
					<td>
						<div class="flex align_center">
							...
							<input type="text" id="reqHp" name="reqHp" maxlength="20" class="form_text w100p"/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="flex align_center">
							...
							<input type="text" id="reqPhone" name="reqPhone" maxlength="20" class="form_text w100p"/>
						</div>
					</td>
					</td>
					<th scope="row">FAX</th>
					<td>
						<div class="flex align_center">
							...
							<input type="text" id="reqFax" name="reqFax" maxlength="20" class="form_text w100p"/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="flex align_center">
							...
							<input type="hidden" id="reqEmail" name="reqEmail"/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3"><input type="text" id="reqTitle" name="reqTitle" class="form_text w100p"></td>
				</tr>
				<tr>
					<th scope="row">분야 <strong class="point">*</strong></th>
					<td>
						<div class="flex align_center">
							<select id="reqRgfHight" name="reqRgfHight" class="form_select">
				...
				<tr>
					<th scope="row">내용</th>
					<td colspan="3">
						<textarea id="reqContents" name="reqContents" rows="5" class="form_textarea">
	(작성 예시)
	· 현황 및 문제점 :
	· 요청 사항 :

	* 접수된 애로/규제에 대해 유선, 이메일 등을 통해 구체적으로 문의 드릴 수 있습니다.</textarea>
					</td>
				</tr>
				<tr>
					...
					<td colspan="3">
						<div class="form_file">
							...
							<label class="file_btn">
								<input type="file" id="fileName1" name="attach" />
				...
				<tr>
					...
					<td colspan="3">
						<div class="form_file">
							<p class="file_name">첨부파일을 선택하세요</p>
							<label class="file_btn">
								<input type="file" id="fileName2" name="attach" />
								<span class="btn_tbl">찾아보기</span>
							</label>
						</div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<div class="form_file">
							<p class="file_name">첨부파일을 선택하세요</p>
							<label class="file_btn">
								<input type="file" id="fileName3" name="attach" />
								<span class="btn_tbl">찾아보기</span>
							</label>
						</div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<div class="form_file">
							<p class="file_name">첨부파일을 선택하세요</p>
							<label class="file_btn">
								<input type="file" id="fileName4" name="attach" />
								<span class="btn_tbl">찾아보기</span>
							</label>
						</div>
					</td>
				...
				<tr>
					...
					<td colspan="3">
						<div class="form_file">
							<p class="file_name">첨부파일을 선택하세요</p>
							<label class="file_btn">
								<input type="file" id="fileName5" name="attach" />
								<span class="btn_tbl">찾아보기</span>
							</label>
						</div>
					</td>
...
<script type="text/javascript">
	...
	$("select[name=reqRgfHight]").on("change",function(){
		var reqRgfHight = $(this).find(':selected').data('etc1')
		$.ajax({
			type:"post",
			url:"/tradeSOS/problem/selecttReqCatMiddelCodeListAjax.do",
			data: { catHight : reqRgfHight},
	...
	function fnSubmit() {
		...
		if(isStringEmpty( form.reqRgfHight.value)){
			alert("분야는 필수선택 사항입니다");
			form.reqRgfHight.focus();
			return;
		}
		...
		if (confirm('저장 하시겠습니까?')) {
			...
			global.ajaxSubmit($('#submitForm'), {
				type: 'POST'
				, url: '<c:url value="/tradeSOS/problem/regulationFreeSuggestProc.do" />'
