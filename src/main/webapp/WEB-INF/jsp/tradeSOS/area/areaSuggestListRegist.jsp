...
<script type="text/javascript">
	...
	function fn_list() {
		document.searchInsertForm.action = "/tradeSOS/area/areaSuggestList.do";
...
<div class="page_tradesos">
				...
				<tbody>
					<tr>
						...
						<td>
							<div class="flex align_center">
								<span class="form_search w100p">
									<input class="form_text" type="text" id="companyNm" name="companyNm" maxlength="70">
						...
						<td>
							<div class="flex align_center">
								<span class="form_search w100p">
									<input type="text" id="tradeNum" name="tradeNo" class="form_text" onkeypress="fnNumber(this)" maxlength="20">
					...
					<tr>
						...
						<td>
							<div class="flex align_center">
								<span class="form_search w100p">
									<input type="text" id="regNo" name="companyNo" class="form_text" onkeypress="fnNumber(this)" maxlength="20">
			...
			<table class="formTable">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="3">
							<textarea  name="reqContent" rows="3" class="form_textarea" maxlength="1000000" onkeyup="return textareaMaxLength(this);"></textarea>
						</td>
					</tr>
				</tbody>
			...
			<table class="formTable">
				...
				<tbody>
					...
					<tr>
						...
						<th scope="row">법률</th>
						<td><input type="text" class="form_text w100p" placeholder="답변 관련 법률   Ex) 관세법" name="law" maxlength="300"></td>
					</tr>
					<tr>
						<th scope="row">조항</th>
						<td><input type="text" class="form_text w100p" placeholder="답변 관련 법률 조항 Ex) 제32조 1항" name="lawClause" maxlength="300"></td>
					</tr>
					<tr>
						<th scope="row" colspan="2">기타참고사항</th>
						<td><input type="text" class="form_text w100p" placeholder="답변에 참고한 정보를 작성해주세요 (관련 문서명 및 사이트 주소)" name="dscr" maxlength="300"></td>
					</tr>
				</tbody>
	...
	<form id="searchInsertForm" name="searchInsertForm">
		...
		<input type="hidden" name="fr_dt" value="${searchVO.frDt}" />
		<input type="hidden" name="to_dt" value="${searchVO.toDt}" />
		<input type="hidden" name="req_tp" value="${searchVO.reqTp}" />
		<input type="hidden" name="chnnel_tp" value="${searchVO.chnnelTp}" />
		<input type="hidden" name="req_status" value="${searchVO.reqStatus}" />
		<input type="hidden" name="caer_nm" value="${searchVO.caerNm}" />
		<input type="hidden" name="trade_no" value="${searchVO.tradeNo}" />
		<input type="hidden" name="req_title" value="${searchVO.reqTitle}" />
		<input type="hidden" name="result_q" value="${searchVO.resultQ}" />
		<input type="hidden" name="open_fg" value="${searchVO.openFg}" />
	</form>
...
<script type="text/javascript">
	...
	function fnCoSearchResult(result){
		...
		$("input[name=company_nm]").val(company_nm);
		$("input[name=trade_no]").val(trade_no);
		$("input[name=company_president]").val(company_president);
		$("input[name=company_no]").val(company_no);
		$("input[name=company_addr]").val(company_addr);
	}
