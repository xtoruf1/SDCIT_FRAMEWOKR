...
<div style="width: 850px;">
	...
	<div class="popup_body">
		<table class="formTable">
			...
			<tr>
				<th>취소사유</th>
				<td>
					<input type="text" id="popupCancelReason" name="popupCancelReason" value="${result.cancelReason}" maxlength="100" class="form_text w100p" placeholder="취소사유를 입력해 주세요." title="취소사유" />
				</td>
			</tr>
		</table>
	</div>
	...
	<div class="btn_group mt-20 _center">
		<button type="button" onclick="doCancelConsult('${result.prvtConsultId}');" class="btn btn_primary btn_modify_auth">상담 예약 취소</button>
	</div>
</div>
<script type="text/javascript">
	...
	function doCancelConsult(consultId) {
		...
		if (confirm('예약취소로 처리 하시겠습니까?')) {
			global.ajax({
				url : '<c:url value="/tradeSOS/exp/cancelExpertPrvtConsult.do" />'
				, dataType : 'json'
				, type : 'POST'
				, data : {
