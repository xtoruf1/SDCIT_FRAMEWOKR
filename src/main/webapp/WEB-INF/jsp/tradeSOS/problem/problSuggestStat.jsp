...
<div class="page_tradesos">
	<div class="location">
		...
		<div class="btnGroup ml-auto">
			...
			<button type="button" class="btn_sm btn_secondary" onclick="fnResetTab()">초기화</button>
								...
								<div class="group_datepicker">
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchStartDate" name="searchStartDate" value="<c:out value="${vo.rec_date_from_year}-${vo.rec_date_from_month}"/>" onchange="fromDateSelectEvent();" class="txt monthpicker" placeholder="시작월" title="시작월" readonly="readonly" />
									...
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchEndDate" name="searchEndDate" value="<c:out value="${vo.rec_date_to_year}-${vo.rec_date_to_month}"/>" onchange="toDateSelectEvent();" class="txt monthpicker" placeholder="종료월" title="종료월" readonly="readonly" />
						...
						<tr>
							...
							<td>
								<div class="group_datepicker">
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchStartDate1" name="searchStartDate" value="<c:out value="${vo.rec_date_from_year}-${vo.rec_date_from_month}"/>" onchange="fromDateSelectEvent1();" class="txt monthpicker" placeholder="시작월" title="시작월" readonly="readonly" />
									...
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchEndDate1" name="searchEndDate" value="<c:out value="${vo.rec_date_to_year}-${vo.rec_date_to_month}"/>" onchange="toDateSelectEvent1();" class="txt monthpicker" placeholder="종료월" title="종료월" readonly="readonly" />
						...
						<tr>
							...
							<td>
								<div class="group_datepicker">
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchStartDate2" name="searchStartDate" value="<c:out value="${vo.rec_date_from_year}-${vo.rec_date_from_month}"/>" onchange="fromDateSelectEvent2();" class="txt monthpicker" placeholder="시작월" title="시작월" readonly="readonly" />
									...
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchEndDate2" name="searchEndDate" value="<c:out value="${vo.rec_date_to_year}-${vo.rec_date_to_month}"/>" onchange="toDateSelectEvent2();" class="txt monthpicker" placeholder="종료월" title="종료월" readonly="readonly" />
						...
						<tr>
							...
							<td>
								<div class="group_datepicker">
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchStartDate3" name="searchStartDate" value="<c:out value="${vo.rec_date_from_year}-${vo.rec_date_from_month}"/>" onchange="fromDateSelectEvent3();" class="txt monthpicker" placeholder="시작월" title="시작월" readonly="readonly" />
									...
									<div class="datepicker_box">
											<span class="form_datepicker">
												<input type="text" id="searchEndDate3" name="searchEndDate" value="<c:out value="${vo.rec_date_to_year}-${vo.rec_date_to_month}"/>" onchange="toDateSelectEvent3();" class="txt monthpicker" placeholder="종료월" title="종료월" readonly="readonly" />
...
<script type="text/javascript">
	...
	function fnResetTab(){
		...
		if (gubun == 'field'){
			$("#fieldSearchForm > input[type=reset]").click();
			getFieldList();
		}else if (gubun == 'route'){
			$("#routeSearchForm > input[type=reset]").click();
			getRouteList();
		}else if (gubun == 'area'){
			$("#areaSearchForm > input[type=reset]").click();
			getAreaList();
		}else if (gubun == 'company'){
			$("#companySearchForm > input[type=reset]").click();
			getCompanyList();
		}
	}
	...
	function getFieldList(){
		...
		global.ajax({
			type:"post",
			url:"/tradeSOS/problem/problSuggestStatFieldListAjax.do",
	...
	function setFiledGrid(data){
		...
		ibHeader.setHeaderMode({Sort: 0, ColMove: true, ColResize: true});
		...
		for (var i = 0 ; i <yearCnt; i++){
			...
			ibHeader.addHeader({Type: "Int", Header: headerData+"|대정부건의"			 ,  SaveName: "cnt0"+i, 	Align: "Right", Width: sWidth,  ZeroToReplaceChar: ''});
			ibHeader.addHeader({Type: "Int", Header: headerData+"|지자체 / 유관기관건의", 	SaveName: "cnt1"+i, 	Align: "Right", Width: sWidth,  ZeroToReplaceChar: ''});
			ibHeader.addHeader({Type: "Int", Header: headerData+"|미건의"				 ,	SaveName: "cnt2"+i, 	Align: "Right", Width: sWidth,  ZeroToReplaceChar: ''});
			ibHeader.addHeader({Type: "Int", Header: headerData+"|전체"					 ,	SaveName: "cnt3"+i, 	Align: "Right", Width: sWidth,  ZeroToReplaceChar: ''});
		...
		//fieldTblSheet.SetMergeCell(10,0,1,2);	//합계행 머지


		// createGrid('fieldTblSheet', 'filedSheet', headers, "100%", "100%" , {  MergeSheet :5, SizeMode:3 } , {editable: false, ColResize: true, statusColHidden: true});
		// loadSearchDataGrid('filedSheet', resultList);
	}
	...
	function getRouteList(){
		...
		global.ajax({
			type:"post",
			url:"/tradeSOS/problem/problSuggestStatRouteListAjax.do",
	...
	function setRouteGrid(data){
		...
		ibHeader.addHeader({Type: "Text"	, Header: "No|No", SaveName: "rnum", 	Align: "Center", 	Width: 80, 	Edit: false });
	...
	function routeTblSheet_OnSearchEnd(Row, Col, Rows, Cols, Align) {
		...
		routeTblSheet.SetDataFontColor("black");
	...
	function getAreaList(){
		...
		global.ajax({
			type:"post",
			url:"/tradeSOS/problem/problSuggestStatAreaListAjax.do",
	...
	function setAreaGrid(data){
		...
		ibHeader.addHeader({Type: "Text"	, Header: "No|No", SaveName: "rnum", 	Align: "Center", 	Width: 60, 	Edit: false });
	...
	function setCompanyGrid(data){
		...
		ibHeader.addHeader({Type: "Text", Header: "업체명"			, SaveName: "COMPNY_NM"  , 	Align: "Left"  , Width: 200 , Wrap: 1});
		ibHeader.addHeader({Type: "Text", Header: "무역업고유번호"		, SaveName: "TRADE_NUM"  , 	Align: "Center", Width: 80 });
		ibHeader.addHeader({Type: "Int", Header: "대정부건의"		, SaveName: "REQTYPECD1" , 	Align: "Right", Width: 110,  ZeroToReplaceChar: '' });
		ibHeader.addHeader({Type: "Int", Header: "지자체/유관기관건의", SaveName: "REQTYPECD2" , 	Align: "Right", Width: 110,  ZeroToReplaceChar: '' });
		ibHeader.addHeader({Type: "Int", Header: "미건의"			, SaveName: "REQTYPECD3" , 	Align: "Right", Width: 110,  ZeroToReplaceChar: '' });
		ibHeader.addHeader({Type: "Int", Header: "전체"				, SaveName: "CNT"		 , 	Align: "Right", Width: 80,  ZeroToReplaceChar: '' });
	...
	function companyTblSheet_OnSearchEnd(Row) {
		...
		// 합계 Merge
		companyTblSheet.SetMergeCell(companyTblSheet.GetDataLastRow(), 0, 1, 3); 		// 합계 Merge (Row Index, Column Index, Row 개수, 머지할 셀의 Col 개수)
