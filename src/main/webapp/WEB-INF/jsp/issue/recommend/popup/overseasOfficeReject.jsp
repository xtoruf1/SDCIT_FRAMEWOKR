...
<div style="width: 500px;">
	...
	<div class="btn_group mt-20 _center">
		<button type="button" onclick="doReject();" class="btn btn_primary btn_modify_auth">추천서 반려</button>
	</div>
</div>
<script type="text/javascript">
	...
	function doReject() {
		if (isValid()) {
			if (confirm('추천서를 반려 하시겠습니까?')) {
				global.ajax({
					url : '<c:url value="/issue/recommend/rejectOverseasOffice.do" />'
					, dataType : 'json'
					, type : 'POST'
					, data : {
						overBranchId : '${param.overBranchId}'
