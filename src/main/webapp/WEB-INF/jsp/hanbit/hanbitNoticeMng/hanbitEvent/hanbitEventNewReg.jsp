...
<form id="searchForm" name="searchForm" method="post">
	...
	<input type="hidden" id="searchStdt" name="searchStdt" value=""/>
	<input type="hidden" id="searchEddt" name="searchEddt" value=""/>
</form>
						...
						<div id="div1">
							<div class="form_file">
								...
								<label class="file_btn">
									<input type="file" id="fileIdx1" name="photoFile" title="파일첨부"/>
