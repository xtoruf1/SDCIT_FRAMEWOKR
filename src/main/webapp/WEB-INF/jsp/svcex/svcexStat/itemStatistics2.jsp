...
<form name="viewForm" id="viewForm" method="post" onsubmit="return false;">
	...
	<input type="hidden" name="listPage"		id="listPage"		value="<c:out value="/svcex/svcexStat/itemStatistics2List.do"/>"/>
	...
	<div class="location compact">
		...
		<!-- 네비게이션 -->
		<div class="ml-auto">
			<button type="button" class="btn_sm btn_primary" onclick="downloadIbSheetExcel(selectListSheet,'한국무역협회 무역지원서비스 품목별수출입(품목월별)','');">엑셀 다운</button>
	...
	<div class="tab_header">
		...
		<button class="tab on" onclick="location.href='/svcex/svcexStat/itemStatistics2List.do'">품목(월)</button>
...
<script type="text/javascript">
	...
	function selectList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/svcex/svcexStat/itemStatistics2DataList.do" />'
