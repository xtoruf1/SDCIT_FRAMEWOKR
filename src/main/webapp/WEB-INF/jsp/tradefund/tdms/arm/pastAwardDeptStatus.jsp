...
<input type="hidden" id="listPage" name="listPage" value="/tdms/arm/pastAwardDeptStatus.do"/>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		setSheetHeader_pastAwardDeptStatusTabSheet();
		setSheetHeader_pastAwardDeptStatusIndiSheet();
		setSheetHeader_pastAwardDeptStatusHunSheet();
		setSheetHeader_pastAwardDeptStatusPyoSheet();
		getTabList();
	});

	function setSheetHeader_pastAwardDeptStatusTabSheet() {

		var	ibHeader = new IBHeader();
		var initSheet = {};

        ibHeader.addHeader({Header:"No",	Type:"Text",      Hidden:1,  Width:60,   Align:"Center",  SaveName:"no" });
        ibHeader.addHeader({Header:"지역",	Type:"Text",      Hidden:0,  Width:60,   Align:"Center",  SaveName:"tradeDeptNm",	CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:30 });
		...
		createIBSheet2(container, 'tabSheet', '100%', '540px');
	...
	function setSheetHeader_pastAwardDeptStatusIndiSheet() {

		var	ibHeader = new IBHeader();
		var initSheet = {};

		ibHeader.addHeader({Header:"No",	Type:"Text",      Hidden:1,  Width:60,   Align:"Center",  SaveName:"no" });
        ibHeader.addHeader({Header:"지역",	Type:"Text",      Hidden:0,  Width:80,   Align:"Center",  SaveName:"tradeDeptNm",	CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:30 });
		...
		createIBSheet2(container, 'indiSheet', '100%', '540px');
	...
	function setSheetHeader_pastAwardDeptStatusHunSheet() {
		...
		createIBSheet2(container, 'hunSheet', '100%', '523px');
	...
	function setSheetHeader_pastAwardDeptStatusPyoSheet() {
		...
		createIBSheet2(container, 'pyoSheet', '100%', '523px');
	...
	function getTabList() {
		...
		global.ajax({
			type : 'POST'
			, url : "/tdms/arm/selectPastAwardDeptStatusTabList.do"
	...
	function getIndiList() {
		...
		global.ajax({
			type : 'POST'
			, url : "/tdms/arm/selectPastAwardDeptStatusIndiList.do"
			, contentType : 'application/json'
			, data : JSON.stringify(searchParams)
			, dataType : 'json'
			, async : true
	...
	function getHunList() {
		...
		global.ajax({
			type : 'POST'
			, url : "/tdms/arm/selectPastAwardDeptStatusHunList.do"
			, contentType : 'application/json'
			, data : JSON.stringify(searchParams)
			, dataType : 'json'
			, async : true
	...
	function getPyoList() {
		...
		global.ajax({
			type : 'POST'
			, url : "/tdms/arm/selectPastAwardDeptStatusPyoList.do"
			, contentType : 'application/json'
			, data : JSON.stringify(searchParams)
			, dataType : 'json'
			, async : true
