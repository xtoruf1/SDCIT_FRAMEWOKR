				...
				<tr>
					...
					<td>
						<select class="form_select" id="searchPrvPriType" name="searchPrvPriType">
							...
							<c:forEach items="${awd032Select}" var="list" varStatus="status">
...
<script type="text/javascript">
	$(document).ready(function(){
		setSheetHeader_tradeDayDelLogSheet();
	});

	// Sheet의 초기화 작업
	function setSheetHeader_tradeDayDelLogSheet() {
		var	ibHeader = new IBHeader();
		var initSheet = {};

		ibHeader.addHeader({Header:"무역업등록번호",	Type:"Text",       Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"memberId",       CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:1,   EditLen:30 });
        ibHeader.addHeader({Header:"업체명",			Type:"Text",   Hidden:0,  Width:100,  Align:"Left",    ColMerge:1,   SaveName:"coNmKr",         CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:30, Cursor:"Pointer" });
        ibHeader.addHeader({Header:"이력구분",			Type:"Text",   Hidden:0,  Width:90,   Align:"Left",    ColMerge:1,   SaveName:"prvPriTypeNm",   CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:30 });
        ibHeader.addHeader({Header:"이력일자",			Type:"Text",   Hidden:0,  Width:80,   Align:"Center",                SaveName:"hisDate",        CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:30 });
        ibHeader.addHeader({Header:"이력내용",			Type:"Text",   Hidden:0,  Width:170,  Align:"Left",    ColMerge:1,   SaveName:"hisCdname",      CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:30 });
        ibHeader.addHeader({Header:"이력사유",			Type:"Text",   Hidden:0,  Width:200,  Align:"Left",    ColMerge:1,   SaveName:"hisResn",        CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:30 });
        ibHeader.addHeader({Header:"이력아이디",		Type:"Text",   Hidden:0,  Width:80,   Align:"Center",  ColMerge:1,   SaveName:"hisUserId",      CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:0,   InsertEdit:0,   EditLen:30 });
	...
	function getList() {
		...
		global.ajax({
			type : 'POST'
			, url : "/tdms/agg/selectTradeDayDelLogList.do"
	...
	function doExcel() {
		downloadIbSheetExcel(listSheet, '신청서변경내역조회_리스트', '');
	}
</script>