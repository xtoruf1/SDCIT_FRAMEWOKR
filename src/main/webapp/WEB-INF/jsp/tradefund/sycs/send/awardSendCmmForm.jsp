...
<div class="search">
	<table class="formTable">
		...
		<tr>
			<th>발신자 전화번호</th>
			<td>
				<input type="text" class="form_text" id="membTelNo" name="membTelNo"  placeholder="발신자전화번호" 	title="발신자전화번호" maxlength="13" required="required"  style="width:80%;" />
			</td>
			<th>발신자 이메일</th>
			<td>
...
// 		}
	...
	function doCodeComSearch() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/sycs/send/sendCmmFormSearchComCodeAward.do" />'
			, data : $('#sendCmmFormForm').serialize()
			, dataType : 'json'
			, async : true
			, spinner : true
