...
<table width="95%" height="700px" align="center" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td valign="top">
		<c:if test="${param.reportGb1 eq 'Y'}">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<colgroup>
					<col width="30px" />
					<col width="100px" />
					<col width="120px" />
				...
				<tr height="25px">
					<td rowspan="8" align="center">①<br />신<br />청<br />업<br />체</td>
					<td align="center">법인번호</td>
					<td align="left"><c:out value="${printVO.corpoNo}" /></td>
					<td rowspan="2" align="center">업체명</td>
					<td>(한글) <c:out value="${printVO.coNmKr}" /></td>
					<td rowspan="2" align="center">대표자</td>
					<td>(한글) <c:out value="${printVO.ceoKr}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">무역업고유번호</td>
					<td><c:out value="${printVO.memberId}" /></td>
					<td>(한자) <c:out value="${common:reverseXss(printVO.coNmCh)}" escapeXml="false" /></td>
					<td>(한자) <c:out value="${common:reverseXss(printVO.ceoNmCh)}" escapeXml="false" /></td>
				</tr>
				<tr height="25px">
					<td colspan="6" align="center">
						<table style="width: 100%;">
							<tr height="25px">
								<td width="60%" align="center">주 소(공장, 사무소 등 전사업장)</td>
								<td width="40%" align="center">산재보험관리번호(공장, 사무소 등 전사업장)</td>
							</tr>
							<c:choose>
								...
								<c:otherwise>
									<c:forEach var="item" items="${indusNoList}" varStatus="status">
										<tr height="25px">
											<td><c:out value="${status.index + 1}" />) (<c:out value="${item.officeNm}" />) <c:out value="${item.addr}" /></td>
											<td>→<c:out value="${item.indusNo1}" />-<c:out value="${item.indusNo2}" /></td>
										</tr>
									</c:forEach>
								</c:otherwise>
							</c:choose>
				...
				<tr height="35px">
					...
					<td colspan="5">
						...
						* 업종구분 : <c:out value="${upMsg}" />
					</td>
				</tr>
				<tr height="25px">
					<td align="center">포상신청</td>
					<td colspan="5">수출의 탑(<c:out value="${priTypeGb}" />), 포상(<c:out value="${priTypeGb2}" />)</td>
				</tr>
				<tr height="25px">
					<td align="center">신청탑종류</td>
					<td colspan="5">
						(<c:out value="${printVO.expTapPrizeNm}" />) 탑 <!-- ※ 예) (100만불)탑 -->
						<br />* 탑업체명 : <c:out value="${printVO.tapCoNmKr}" />
					</td>
				</tr>
				<tr height="25px">
					<td colspan="6">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="50px">
					<td rowspan="4" align="center">②<br />수<br />출<br />실<br />적</td>
					<td align="center">구 분</td>
					<td align="center">전전년도(A)<br /><c:out value="${printVO.twoDayStart}" /> ~<br /> <c:out value="${printVO.twoDayEnd}" /></td>
					<td align="center">전년도(B)<br /><c:out value="${printVO.pastDayStart}" /> ~<br /> <c:out value="${printVO.pastDayEnd}" /></td>
					<td align="center">당해년도(C)<br /><c:out value="${printVO.custDayStart}" /> ~<br /> <c:out value="${printVO.custDayEnd}" /></td>
					<td align="center">최근 3년간<br />평균신장율</td>
					<td align="center">당해년도 주종<br />수출품목(금액순)</td>
				</tr>
				<tr height="25px">
					<td align="center">직수출(A)</td>
					<td align="right">
					...
					<td rowspan="4">
						<table style="width: 100%;">
							<tr height="25px">
								<td style="padding-left: 3px;">1) HS: <c:out value="${printVO.expItemHscode1}" /></td>
							</tr>
							<tr height="25px">
				...
				<tr height="25px">
					<td colspan="2">④무역수지(당해년도)</td>
					<td colspan="5">금액 <c:out value="${printVO.tradeIndex}" /> 천불, 외화가득율 (1※- 2※/ 1※) : <c:out value="${printVO.tradeIndexImprvRate}" /> %</td>
				</tr>
			</table>
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<colgroup>
				...
				<tr height="25px">
					<td rowspan="2" align="center">⑤시장개척<br />(당해년도)</td>
					<td align="center">5대시장</td>
					<td>
						<table style="width: 100%;">
							<tr>
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="25px">
					<td rowspan="4" align="center">⑥<br />기<br />술<br />개<br />발</td>
					<td align="center">신기술개발</td>
					<td colspan="2" align="left" style="word-break: break-all;">품목명 : <c:out value="${printVO.newTechItemNm}" /></td>
					<td align="left" style="word-break: break-all;">인정기관 : <c:out value="${printVO.newTechTerm}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">정부기술개발참여</td>
					<td colspan="2" align="left" style="word-break: break-all;">사업명 : <c:out value="${printVO.govTechNm}" /></td>
					<td align="left" style="word-break: break-all;">시행기관 : <c:out value="${printVO.govTechInst}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">수입대체상품생산</td>
					<td colspan="2" align="left" style="word-break: break-all;">품목수 : <c:out value="${printVO.impReplItemCnt}" /></td>
					<td align="left" style="word-break: break-all;">품목명 : <c:out value="${printVO.impReplItemNm}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">자기상표제품수출</td>
					<td align="left" style="word-break: break-all;">상표수 : <c:out value="${printVO.selfBrandExpCnt}" /></td>
					<td align="left" style="word-break: break-all;">품목수 : <c:out value="${printVO.selfBrandExpItemCnt}" /></td>
					<td align="left" style="word-break: break-all;">상표명 : <c:out value="${printVO.selfBrandExpItemNm}" /></td>
				</tr>
			</table>
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<colgroup>
				...
				<tr height="25px">
					<td colspan="8" align="center">⑦ 유 공 자</td>
				</tr>
				<tr height="25px">
					<td align="center">추 천 자</td>
					<td align="center">성 명</td>
					<td align="center">직 위</td>
					<td align="center">주민등록번호</td>
					<td colspan="2" align="center">근무기간(현 재직회사)</td>
					<td align="center">과거포상기록</td>
					<td align="center">소속사업장</td>
				</tr>
				<tr height="25px">
					<td align="center">대표자</td>
					<td align="left"><c:out value="${printVO.ceoUserNmKor}" /></td>
					<td align="left"><c:out value="${printVO.ceoPos}" /></td>
					<td align="center"><c:out value="${printVO.ceoJuminNo}" /></td>
					<td align="right"><c:out value="${printVO.ceoCurwrkTermYy}" /> 년</td>
					<td align="right"><c:out value="${printVO.ceoCurwrkTermMm}" /> 개월</td>
					<td align="left"><c:out value="${printVO.ceoHistory}" /></td>
					<td align="center"><c:out value="${printVO.ceoDeptPosPlace}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">종업원(사무직)</td>
					<td align="left"><c:out value="${printVO.empUserNmKor}" /></td>
					<td align="left"><c:out value="${printVO.empPos}" /></td>
					<td align="center"><c:out value="${printVO.empJuminNo}" /></td>
					<td align="right"><c:out value="${printVO.empCurwrkTermYy}" /> 년</td>
					<td align="right"><c:out value="${printVO.empCurwrkTermMm}" /> 개월</td>
					<td align="left"><c:out value="${printVO.empHistory}" /></td>
					<td align="center"><c:out value="${printVO.empDeptPosPlace}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">종업원(생산직)</td>
					<td align="left"><c:out value="${printVO.workUserNmKor}" /></td>
					<td align="left"><c:out value="${printVO.workPos}" /></td>
					<td align="center"><c:out value="${printVO.workJuminNo}" /></td>
					<td align="right"><c:out value="${printVO.workCurwrkTermYy}" /> 년</td>
					<td align="right"><c:out value="${printVO.workCurwrkTermMm}" /> 개월</td>
					<td align="left"><c:out value="${printVO.workHistory}" /></td>
					<td align="center"><c:out value="${printVO.workDeptPosPlace}" /></td>
				</tr>
			</table>
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<tr height="25px">
				...
				<tr height="25px">
					<td align="center" style="padding-left: 390px;font-size: 15px;font-weight: bold;">
						...
						<c:choose>
							<c:when test="${empty item.certBase64Image}">
								(인)
							</c:when>
							<c:otherwise>
								<img src="<c:out value="${item.certBase64Image}" />" style="width: 80px;height: 80px;" />
							</c:otherwise>
						</c:choose>
					</td>
				</tr>
		...
		<c:if test="${param.reportGb4 eq 'Y'}">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="25px">
					<td rowspan="10" align="center">①<br />신<br />청<br />업<br />체</td>
					<td align="center">법인번호</td>
					<td><c:out value="${printVO.corpoNo}" /></td>
					<td rowspan="2" align="center">업체명</td>
					<td>(한글) <c:out value="${printVO.coNmKr}" /></td>
					<td rowspan="2" align="center">대표자</td>
					<td>(한글) <c:out value="${printVO.ceoKr}" /></td>
				...
				<tr height="25px">
					...
					<td colspan="5">본사 : <c:out value="${printVO.coAddr1}" /> <c:out value="${printVO.coAddr2}" /></td>
				</tr>
				<tr height="25px">
					<td align="center">신청탑종류</td>
					<td colspan="5">
						(<c:out value="${printVO.expTapPrizeNm}" />) 탑
						<br />* 탑업체명 : <c:out value="${printVO.tapCoNmKr}" />
					</td>
				</tr>
				<tr height="25px">
					<td align="center">업체구분</td>
					<td colspan="5">대기업(<c:out value="${scaleGb}" />), 중견기업(<c:out value="${scaleGb6}" />), 중소기업(<c:out value="${scaleGb2}" />)</td>
				</tr>
				<tr height="25px">
					<td rowspan="2" align="center">담당자</td>
					<td colspan="5">
						<table style="width: 100%;">
							<tr>
								<td width="10%">성명 : </td>
				...
				<tr height="25px">
					<td colspan="5">E-Mail : <c:out value="${printVO.userEmail}" /></td>
				</tr>
				<tr height="25px">
					<td colspan="6">
						<table style="width: 100%;">
				...
				<tr height="25px">
					<td colspan="6">산재보험관리번호 : <c:out value="${indusNoList[0].indusNo1}" />-<c:out value="${indusNoList[0].indusNo2}" /></td>
				</tr>
			</table>
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<colgroup>
				...
				<tr height="25px">
					...
					<td align="right">
						<table style="width: 95%;">
							<tr height="25px">
								<td width="60%" align="right" style="padding-right: 3px;"><c:out value="${printVO.twoDrExpAmtP}" /></td>
								<td width="40%" align="left">천불</td>
							</tr>
						</table>
					</td>
					<td align="right">
						<table style="width: 95%;">
							<tr height="25px">
								<td width="60%" align="right" style="padding-right: 3px;"><c:out value="${printVO.pastDrExpAmtP}" /></td>
								<td width="40%" align="left">천불</td>
							</tr>
						</table>
					</td>
					<td align="right">
						<table style="width: 95%;">
							<tr height="25px">
								<td width="60%" align="right" style="padding-right: 3px;"><c:out value="${printVO.currDrExpAmtP}" /></td>
								<td width="40%" align="left">천불</td>
							</tr>
						</table>
					</td>
					...
					<td rowspan="4" style="word-break: break-all;">
						<table style="width: 100%;">
							<tr height="25px">
		...
		<c:if test="${param.reportGb2 eq 'Y'}">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="35px">
					<td rowspan="2">(2) 주민등록<br />&nbsp;&nbsp;&nbsp;번 &nbsp;&nbsp;&nbsp;호<br />&nbsp;(생년월일)</td>
					<td align="center"><c:out value="${item.juminNoDis}" /></td>
					<td>(3) 군번(군인의 경우)</td>
				</tr>
				...
				<tr height="35px">
					<td align="center"><c:out value="${birthDay1}" />년 <c:out value="${birthDay2}" />월 <c:out value="${birthDay3}" />일</td>
					<td align="center">해당없음</td>
				</tr>
				<tr height="35px">
					<td>(4) 국 적</td>
					<td colspan="2"><c:out value="${item.bonjuk}" /></td>
				</tr>
				<tr height="35px">
					<td>(5) 주 소</td>
					<td colspan="2"><c:out value="${item.zipCd}" /> <c:out value="${item.addr1}" /> <c:out value="${item.addr2}" /></td>
				</tr>
			</table>
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<colgroup>
				...
				<tr height="35px">
					<td>(6) 직 업</td>
					<td>(7) 소 속</td>
					<td colspan="2">(8) 소속사업장 산재보험관리번호</td>
				</tr>
				<tr height="35px">
					<td><c:out value="${item.job}" /></td>
					<td><c:out value="${item.deptPos}" /></td>
					<td colspan="2"><c:out value="${item.deptPosPlace}" /></td>
				</tr>
				<tr height="50px">
					<td>(9) 직 위</td>
					<td>(10) 등 급(직급ㆍ계급)</td>
					<td>(11) 동종업체 <br /> &nbsp;&nbsp;&nbsp;총 수공기간</td>
					<td>(12) 현 소속 <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;근무기간</td>
				</tr>
				<tr height="35px">
					<td><c:out value="${item.pos}" /></td>
					<td><c:out value="${item.rank}" /></td>
					<td align="center"><c:out value="${item.wrkTermYy}" />년 <c:out value="${item.wrkTermMm}" />개월</td>
					<td align="center"><c:out value="${item.curwrkTermYy}" />년 <c:out value="${item.curwrkTermMm}" />개월</td>
				</tr>
				<tr height="35px">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="35px">
					<td colspan="4" align="center">조 사 자</td>
				</tr>
				<tr height="35px">
					<td>(16) 소 속</td>
					<td></td>
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="35px">
					<td colspan="4" align="center" style="font-weight: bold;">국가연구개발 사업 참여제재 여부(해당사항 있는 경우 반드시 기재)</td>
				</tr>
				<tr height="35px">
					<td align="center">(20) 제재시작일</td>
					<td align="center">(21) 제재종료일</td>
					<td colspan="2" align="center">(22) 제재사유</td>
				</tr>
				...
				<c:forEach var="item4" items="${awd0021T}" varStatus="status4">
					<c:if test="${item.prvPriType eq item4.prvPriType and item4.type eq '30001'}">
						<c:set var="item4Count" value="${status4.index}" />
						<tr height="35px">
							<td align="center"><c:out value="${item4.historyDt}" /></td>
							<td align="center"><c:out value="${item4.historyToDt}" /></td>
							<td colspan="2"><c:out value="${item4.history}" /></td>
						</tr>
					</c:if>
				</c:forEach>
				...
				<tr height="35px">
					<td colspan="4" align="center" style="font-weight: bold;">주요경력(민간 및 군사 학력과 경력)</td>
				</tr>
				<tr height="35px">
					<td align="center">(23) 년 월 일</td>
					<td align="center">(24) 이 력</td>
					<td align="center">(25) 년 월 일</td>
					<td align="center">(26) 이 력</td>
				</tr>
				...
				<c:forEach var="item1" items="${awd0021T}" varStatus="status1">
					<c:if test="${item.prvPriType eq item1.prvPriType and (item1.type eq '10001' or item1.type eq '10002')}">
						...
						<td align="center"><c:out value="${item1.historyDt}" />~<c:out value="${item1.historyToDt}" /></td>
						<td><c:out value="${item1.history}" /></td>
				...
				<tr height="35px">
					<td colspan="4" align="center" style="font-weight: bold;">과거 포상기록(훈장ㆍ포장ㆍ표창별로 기록)</td>
				</tr>
				<tr height="35px">
					<td align="center">(27) 년 월 일</td>
					<td align="center">(28) 내 용</td>
					<td align="center">(29) 년 월 일</td>
					<td align="center">(30) 내 용</td>
				</tr>
				...
				<c:forEach var="item2" items="${awd0021T}" varStatus="status2">
					<c:if test="${item.prvPriType eq item2.prvPriType and item2.type eq '20001'}">
						...
						<td align="center"><c:out value="${item2.historyDt}" />~<c:out value="${item2.historyToDt}" /></td>
						<td><c:out value="${item2.history}" /></td>
				...
				<tr height="35px">
					<td colspan="4" align="center">(31) 공 적 사 항</td>
				</tr>
				<tr>
					<td colspan="4" style="padding-top: 5px; padding-bottom: 5px; padding-left: 5px; padding-right: 5px;border-right: #000000 solid 1px;word-break: break-all;">
					<c:choose>
			...
			<table align="center" style="width: 700px;">
				...
				<tr height="25px">
					<td style="padding-left: 10px;">(31) <span style="font-weight: bold;">공적사항</span>에는 다음항목을 순서에 따라 서술적으로 작성(※  A4용지 2매 이상-5매 이내)</td>
				</tr>
				<tr height="25px">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="35px">
					<td colspan="2" style="padding-top: 5px;padding-bottom: 5px;word-break: break-all;">
		...
		<c:if test="${param.reportGb3 eq 'Y' or param.reportGb5 eq 'Y'}">
			...
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				...
				<tr height="35px">
					<td rowspan="5" valign="middle">
						<c:if test="${not empty item.attPictId}">
							<img src="<c:out value="${item.base64Image}" />" style="width: 160px;height: 190px;" />
						</c:if>
					</td>
				...
				<tr height="35px">
					...
					<td align="left">(한글) <c:out value="${item.userNmKor}" /></td>
				</tr>
				<tr height="35px">
					<td align="left">(한자) <c:out value="${common:reverseXss(item.userNmCh)}" escapeXml="false" /></td>
				</tr>
				<tr height="35px">
					<td align="center">주민등록번호</td>
					<td align="center">
				...
				<tr height="35px">
					<td align="center">현 근 무 처</td>
					<td align="left"><c:out value="${printVO.coNmKr}" /></td>
				</tr>
			</table>
			<table align="center" border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" style="width: 700px;border-collapse: collapse;">
				<colgroup>
				...
				<tr height="35px">
					<td align="center">현 주 소</td>
					<td colspan="4"><c:out value="${item.zipCd}" /> <c:out value="${item.addr1}" /> <c:out value="${item.addr2}" /></td>
				</tr>
				<tr height="35px">
					<td align="center">이메일</td>
					<td><c:out value="${item.email}" /></td>
					<td align="center" class="phoneNum">휴대폰</td>
					<td colspan="2">
				...
				<tr height="35px">
					...
					<td colspan="3" align="center">학 력 및 경 력 사 항</td>
					<td align="center">발 령 자</td>
				</tr>
				...
				<c:forEach var="trade" items="${awd0021T}" varStatus="tradeStatus1">
					<c:if test="${item.prvPriType eq trade.prvPriType and trade.type eq '10001'}">
						...
						<tr height="35px">
							<td align="center"><c:out value="${trade.historyDt}" /> ~ <c:out value="${trade.historyToDt}" /></td>
							<td colspan="3"><c:out value="${trade.history}" /></td>
							<td align="center"><c:out value="${trade.historyOwner}" /></td>
						</tr>
					</c:if>
				</c:forEach>
				...
				<tr height="25px;">
					<td align="right" style="padding-right: 50px;font-size: 15px;">
						...
						<c:choose>
							...
							<c:otherwise>
								<c:choose>
									<c:when test="${empty item.signBase64Image}">
										(인)
									</c:when>
									<c:otherwise>
										<img src="<c:out value="${item.signBase64Image}" />" style="width: 80px;height: 80px;" />
									</c:otherwise>
								</c:choose>
							</c:otherwise>
						</c:choose>
		...
		<c:if test="${param.reportGb6 eq 'Y'}">
			...
			<table style="width: 700px;border-top: #000000 solid 1px;border-left: #000000 solid 1px;">
				<colgroup>
					<col width="50px" />
					<col width="100px" />
					<col width="150px" />
				...
				<tr height="25px">
					<td rowspan="2" align="center">추천<br />기관</td>
				...
				<tr height="25px">
					<td rowspan="2" align="center">연번</td>
					<td rowspan="2" align="center">추천부문</td>
					<td rowspan="2" align="center">성명<br />(주민등록번호)</td>
					<td rowspan="2" align="center">소속</td>
					<td rowspan="2" align="center">직위</td>
					<td rowspan="2" align="center">과거포상기록<br />(증빙서사본첨부)</td>
				...
				<c:forEach var="countItem" begin="1" end="10" step="1">
					<tr height="25px">
						<td align="center"><c:out value="${countItem}" /></td>
						<td align="center"></td>
						<td align="center"></td>
						<td align="center"></td>
						<td align="center"></td>
			...
			<table style="width: 700px;border-right: #000000 solid 1px;border-left: #000000 solid 1px;border-bottom: #000000 solid 1px;">
				<colgroup>
					<col width="50px" />
					<col width="700px" />
				</colgroup>
			...
			<table style="width: 700px;border-right: #000000 solid 1px;border-left: #000000 solid 1px;">
				<tr height="25px">
