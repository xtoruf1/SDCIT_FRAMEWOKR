		...
		<tbody>
			<tr>
				...
				<td>
					<div class="datepicker_box">
						<span class="form_datepicker">
							<input type="text" id="fndYdt1" name="fndYdt1"  value="" class="txt datepicker" placeholder="1차상환일" title="1차상환일" readonly="readonly" />
				...
				<td>
					<div class="datepicker_box">
						<span class="form_datepicker">
							<input type="text" id="fndYdt2" name="fndYdt2"  value="" class="txt datepicker" placeholder="2차상환일" title="2차상환일" readonly="readonly" />
							<img src="<c:url value='/images/icon_calender.png' />" class="ui-datepicker-trigger" alt="캘린더" title="캘린더" />
							<input type="hidden" id="dummyStartAloneDate" value="" />
						</span>
			...
			<tr>
				...
				<td>
					<div class="datepicker_box">
						<span class="form_datepicker">
							<input type="text" id="fndYdt3" name="fndYdt3" value="" class="txt datepicker" placeholder="3차상환일" title="3차상환일" readonly="readonly" />
							<img src="<c:url value='/images/icon_calender.png' />" class="ui-datepicker-trigger" alt="캘린더" title="캘린더" />
							<input type="hidden" id="dummyStartAloneDate" value="" />
						</span>
				...
				<td>
					<div class="datepicker_box">
						<span class="form_datepicker">
							<input type="text" id="fndYdt4" name="fndYdt4" value="" class="txt datepicker" placeholder="4차상환일" title="4차상환일" readonly="readonly" />
							<img src="<c:url value='/images/icon_calender.png' />" class="ui-datepicker-trigger" alt="캘린더" title="캘린더" />
							<input type="hidden" id="dummyStartAloneDate" value="" />
						</span>
...
<script type="text/javascript">
	...
	function initIBSheet(){
		...
		ibHeader.addHeader({Header:"선택|선택",           	Type:"CheckBox",  Hidden:false,  Width:50,   Align:"Center",  ColMerge:true,   SaveName:"delCheck"            });
		ibHeader.addHeader({Header:"Status|Status",    	Type:"Status",    Hidden:true,   Width:80,   Align:"Center",  ColMerge:true,   SaveName:"status"              });
		ibHeader.addHeader({Header:"지역본부|지역본부",     	Type:"Text",      Hidden:false,  Width:120,  Align:"Left",    ColMerge:true,   SaveName:"tradeDeptNm",       CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"무역업번호|무역업번호",   	Type:"Text",      Hidden:false,  Width:80,   Align:"Left",    ColMerge:true,   SaveName:"bsNo",              CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"회사명|회사명",        	Type:"Text",      Hidden:false,  Width:180,  Align:"Left",    ColMerge:true,   SaveName:"coNmKor",           CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 , Ellipsis:true});
		ibHeader.addHeader({Header:"사업자번호|사업자번호",   	Type:"Text",      Hidden:false,  Width:100,  Align:"Center",  ColMerge:true,   SaveName:"industryNoNm",      CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"신청액|신청액",        	Type:"Float",     Hidden:false,  Width:120,  Align:"Right",   ColMerge:true,   SaveName:"necessAmount",      CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"추천|추천일",         	Type:"Text",      Hidden:false,  Width:80,   Align:"Center",  ColMerge:false,  SaveName:"recdDate",          CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"추천|추천액",         	Type:"Float",     Hidden:false,  Width:90,   Align:"Right",   ColMerge:false,  SaveName:"recdAmount",        CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자|1차융자일",       	Type:"Text",      Hidden:false,  Width:80,   Align:"Center",  ColMerge:false,  SaveName:"recdDt",            CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자|1차융자금",       	Type:"AutoSum",   Hidden:false,  Width:90,   Align:"Right",   ColMerge:false,  SaveName:"defntAmount",       CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자|2차융자일",       	Type:"Text",      Hidden:false,  Width:80,   Align:"Center",  ColMerge:false,  SaveName:"recdDt2",           CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자|2차융자금",       	Type:"AutoSum",   Hidden:false,  Width:90,   Align:"Right",   ColMerge:false,  SaveName:"defntAmount2",      CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자|3차융자일",       	Type:"Text",      Hidden:false,  Width:80,   Align:"Center",  ColMerge:false,  SaveName:"recdDt3",           CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자|3차융자금",      	Type:"AutoSum",   Hidden:false,  Width:90,   Align:"Right",   ColMerge:false,  SaveName:"defntAmount3",      CalcLogic:"",   Format:"Float",       PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자은행|융자은행",     	Type:"Text",      Hidden:false,  Width:100,  Align:"Center",  ColMerge:true,   SaveName:"mainBankNm",        CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30, Ellipsis:true });
		ibHeader.addHeader({Header:"융자지점명|융자지점명",   	Type:"Text",      Hidden:false,  Width:150,  Align:"Left",    ColMerge:true,   SaveName:"mainBankBranchNm",  CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"생성여부|생성여부",      	Type:"Text",      Hidden:false,  Width:80,   Align:"Center",  ColMerge:true,   SaveName:"cnt",               CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"융자은행코드|융자은행코드",	Type:"Text",      Hidden:true,   Width:80,   Align:"Left",    ColMerge:true,   SaveName:"mainBankCd",        CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"은행변경|은행변경",     	Type:"Text",      Hidden:true,   Width:80,   Align:"Left",    ColMerge:true,   SaveName:"bankYn",            CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
		ibHeader.addHeader({Header:"중도상환|중도상환",     	Type:"Text",      Hidden:true,   Width:80,   Align:"Left",    ColMerge:true,   SaveName:"fndYn",             CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 });
	...
	function getList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/rpm/selectRepaymentRegisteList.do" />'
	...
	function doSave() {
		...
		/*
		if(parseFloat(f.H_FND_YDT1.value.replace(/-/gi ,"").substring(0, 6)) != parseFloat(f.FND_YDT1.value.replace(/-/gi ,"").substring(0, 6))){

			dlgAlert("일 까지만 바꿀수 있습니다.");
			f.FND_YDT1.focus();
			return;

		}

		if(parseFloat(f.H_FND_YDT2.value.replace(/-/gi ,"").substring(0, 6)) != parseFloat(f.FND_YDT2.value.replace(/-/gi ,"").substring(0, 6))){
		...
		if(parseFloat(f.H_FND_YDT3.value.replace(/-/gi ,"").substring(0, 6)) != parseFloat(f.FND_YDT3.value.replace(/-/gi ,"").substring(0, 6))){
		...
		if(parseFloat(f.H_FND_YDT4.value.replace(/-/gi ,"").substring(0, 6)) != parseFloat(f.FND_YDT4.value.replace(/-/gi ,"").substring(0, 6))){
		...
		*/
		...
		var ccf = getSaveDataSheetList('form1' , saveJson);
 		...
 		global.ajax({
 			type : 'POST'
 			, url : '<c:url value="/tfms/rpm/saveRepaymentRegisteList.do" />'
	...
	function doDelete(){
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/rpm/deleteRepaymentRegisteList.do" />'
			, data : JSON.stringify(ccf)
			, contentType : 'application/json'
			, dataType : 'json'
			, async: false
		...
		with(sheet1) {
			for(var i=1; i<=LastRow(); i++){
				...
				if(GetCellValue(i, "cnt") == "미생성"){
					sheet1.SetCellFontColor(i, "cnt",'#0000ff');
				}
			}
		}
    }
