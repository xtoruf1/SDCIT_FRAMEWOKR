...
<script type="text/javascript">
	...
	function initIBSheet(){
		...
		ibHeader.addHeader({Header:"회사명",     	Type:"Text",      Hidden:false,  Width:130,  Align:"Left",    SaveName:"coNmKor",           CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30 , Ellipsis:true});
		...
		ibHeader.addHeader({Header:"지부명",     	Type:"Text",      Hidden:false,  Width:100,  Align:"Left",    SaveName:"tradeDeptNm",       CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30, Ellipsis:true });
		...
		ibHeader.addHeader({Header:"1차융자일",   	Type:"Date", 	  Hidden:false,  Width:120,  Align:"Center",  SaveName:"recdDt",            CalcLogic:"",   Format:"yyyy-MM-dd" });
		ibHeader.addHeader({Header:"1차융자금",   	Type:"AutoSum",   Hidden:false,  Width:100,  Align:"Right",   SaveName:"defntAmount",       CalcLogic:"",   Format:"Integer" });
		ibHeader.addHeader({Header:"2차융자일",   	Type:"Date", 	  Hidden:false,  Width:120,  Align:"Center",  SaveName:"recdDt2",           CalcLogic:"",   Format:"yyyy-MM-dd" });
		ibHeader.addHeader({Header:"2차융자금",   	Type:"AutoSum",   Hidden:false,  Width:100,  Align:"Right",   SaveName:"defntAmount2",      CalcLogic:"",   Format:"Integer" });
		ibHeader.addHeader({Header:"3차융자일",   	Type:"Date", 	  Hidden:false,  Width:120,  Align:"Center",  SaveName:"recdDt3",           CalcLogic:"",   Format:"yyyy-MM-dd" });
		ibHeader.addHeader({Header:"3차융자금",   	Type:"AutoSum",   Hidden:false,  Width:100,  Align:"Right",   SaveName:"defntAmount3",      CalcLogic:"",   Format:"Integer" });
		...
		ibHeader.addHeader({Header:"비고",       	Type:"Text",      Hidden:false,  Width:130,  Align:"Left",    SaveName:"fndMemo"          , Ellipsis:true  });


		ibHeader.setConfig({AutoFitColWidth: 'colhidden|rowtransaction', Page: 10, SearchMode: 2, DeferredVScroll: 1, SizeMode: 4, MouseHoverMode: 2, NoFocusMode : 0, FrozenCol:5,  statusColHidden: true, UseHeaderSortCancel: 1, MaxSort: 1});
	...
	function initIBExcelSheet(){
        ...
        ibHeader.addHeader({Header:"1차융자일",       	Type:"Text",      Hidden:false,  Width:120,  Align:"Center",  SaveName:"recdDt",            CalcLogic:"",   Format:"" });
        ibHeader.addHeader({Header:"확정금액(1차분)", 	Type:"Int",       Hidden:false,  Width:100,  Align:"Right",   SaveName:"defntAmount",       CalcLogic:"",   Format:"Integer" });
        ibHeader.addHeader({Header:"2차융자일",       	Type:"Text",      Hidden:false,  Width:120,  Align:"Center",  SaveName:"recdDt2",           CalcLogic:"",   Format:"" });
        ibHeader.addHeader({Header:"확정금액(2차분)", 	Type:"Int",       Hidden:false,  Width:100,  Align:"Right",   SaveName:"defntAmount2",      CalcLogic:"",   Format:"Integer" });
        ibHeader.addHeader({Header:"3차융자일",       	Type:"Text",      Hidden:false,  Width:120,  Align:"Center",  SaveName:"recdDt3",           CalcLogic:"",   Format:"" });
        ibHeader.addHeader({Header:"확정금액(3차분)", 	Type:"Int",       Hidden:false,  Width:100,  Align:"Right",   SaveName:"defntAmount3",      CalcLogic:"",   Format:"Integer" });
//         ibHeader.addHeader({Header:"융자은행",        	Type:"Text",      Hidden:true,   Width:100,  Align:"Center",  SaveName:"mainBankCd"         });
	...
	function getList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/rpm/selectLoanRegisteList.do" />'
	...
	function getExcelList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/rpm/selectLoanRegisteExcelList.do" />'
			, data : $('#form1').serialize()
			, dataType : 'json'
			, async : true
			, spinner : true
...
// 		if(f.searchSvrId.value == "" || f.searchSvrId.value == null){
		...
		var industryNoNmChk = sheet1.ColValueDup("industryNo");

		if(industryNoNmChk > 0) {
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/rpm/saveLoanRegisteList.do" />'
	...
	function doExcelBank(){
        ...
        if(excelSheet.RowCount() > 0){
        	//fnIbsheetExcelDown(excelSheet, "1", f.searchTitle.value, "1", "A4", "", rowSkip.toString(), -1, false);
	...
	function doExcelUpload(){
		...
		//var ColumnMapping = "0|0|0|0|4|5|6|3|0|0|0|7|8|9|10|11|12|13|1|2|0|1=>mainBankCd|0|0|0|14";

		var ColumnMapping = "0|0|0|0|4|5|6|3|0|0|0|7|8|9|10|11|12|13|1|2|0|1|0|0|0|15";
	...
	function sheetValueCheck(){
		...
		if(sheetObj.RowCount() > 0){
			...
			for(var i = 0; sheetObj.RowCount() >= i; i++){
				...
				if(sheetObj.GetCellValue(i, "defntAmount") != 0 && sheetObj.GetCellValue(i, "defntAmount") != ""){
					...
					if(parseFloat(sheetObj.GetCellValue(i, "defntAmount")) > parseFloat(sheetObj.GetCellValue(i, "recdAmount"))){
						alert("1차 융자금이 추천금액보다 많을 수 없습니다.");
				...
				if( (parseFloat(sheetObj.GetCellValue(i, "defntAmount")) + parseFloat(sheetObj.GetCellValue(i, "defntAmount2")) + parseFloat(sheetObj.GetCellValue(i, "defntAmount3"))) > parseFloat(sheetObj.GetCellValue(i, "recdAmount")) ){
