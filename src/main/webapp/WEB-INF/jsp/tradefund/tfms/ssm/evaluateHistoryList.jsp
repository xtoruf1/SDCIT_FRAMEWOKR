...
<script type="text/javascript">
	...
	function initIBSheet(){
		...
		ibHeader.addHeader({Header:"무역업고유번호|무역업고유번호",                 	Type:"Text",      Hidden:false,  Width:120,   Align:"Center",  ColMerge:true,   SaveName:"bsNo",               CalcLogic:"",   Format:"",            PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		...
		ibHeader.addHeader({Header:"매출액|매출액",                            		Type:"Int",       Hidden:false,  Width:150,  Align:"Right",   ColMerge:true,   SaveName:"salAmount",          CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		...
		ibHeader.addHeader({Header:"전년도수출|전년도수출",                       	Type:"Int",       Hidden:false,  Width:150,  Align:"Right",   ColMerge:true,   SaveName:"expAmount",          CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		...
		ibHeader.addHeader({Header:"심사평가점수내역|수상경력",                     Type:"Int",       Hidden:false,  Width:80,   Align:"Center",  ColMerge:false,  SaveName:"pointKita04",        CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		ibHeader.addHeader({Header:"심사평가점수내역|특허",                       	Type:"Int",       Hidden:false,  Width:80,   Align:"Center",  ColMerge:false,  SaveName:"pointKita05",        CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		...
		ibHeader.addHeader({Header:"신청금액|신청금액",                         	Type:"Int",       Hidden:false,  Width:120,  Align:"Right",   ColMerge:true,   SaveName:"necessAmount",       CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		ibHeader.addHeader({Header:"추천금액|추천금액",                         	Type:"Int",       Hidden:false,  Width:120,  Align:"Right",   ColMerge:true,   SaveName:"recdAmount",         CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
		ibHeader.addHeader({Header:"추천율(%)|추천율(%)",                      	Type:"Int",       Hidden:false,  Width:80,  Align:"Center",  ColMerge:true,   SaveName:"recdRate",           CalcLogic:"",   Format:"Integer",     PointCount:0,   UpdateEdit:false,   InsertEdit:true,   EditLen:30,    Wrap:true });
...
// 		sheet1.SetDataLinkMouse("coNmKor", true);
	...
	function getList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/ssm/selectEvaluateHistoryList.do" />'
	...
	function getOldList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/ssm/selectEvaluateHistoryOldList.do" />'
			, data : $('#form1').serialize()
			, dataType : 'json'
			, async : true
			, spinner : true
