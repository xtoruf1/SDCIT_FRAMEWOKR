...
<input type="hidden" name="amountMax"  id="amountMax" value="<c:out value="${amountMax.amountMax}"/>" />
<!-- 보모 페이지 검색 조건 -->
	...
	<table class="formTable">
		...
		<table class="formTable">
	 	...
	 	<table class="formTable">
			...
			<tr>
				<th rowspan="4"align="left" >(17)<br/><span style="padding-left:3px">수출마케팅</span></th>
				<th rowspan="2" align="center">수상경력<br/>(최근3년이내)</th>
				<th>수상</th>
				<td colspan="3" >
					<select id="prizeCd" name="prizeCd" class="form_select"  >
						<c:forEach var="item" items="${JCS001}" varStatus="status">
							<option value="<c:out value="${item.detailcd}"/>" <c:if test="${item.detailcd eq fundVo.prizeCd}">selected="selected"</c:if>><c:out value="${item.detailnm}"/></option>
						</c:forEach>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td colspan="3">
					<div class="form_row w100p">
						<input type="text" class="form_text align_l" id="backPrizeYn" name="backPrizeYn" value="<c:out value="${fundVo.backPrizeYn}"/>" maxlength="50" title="포상내용" /><span class="append">(수출탑제외)</span>
					</div>
				</td>
			</tr>
			<tr>
				<th colspan="2">기술관련사항(최근 3년이내)</th>
				<td colspan="3" >
					<div class="form_row">
						<label class="label_form" for="tecnlg">
							<input type="checkbox" class="form_checkbox" name="tecnlg" id="tecnlg" value="Y" onClick="tecnlgCheck('true')"  <c:out value="${tecnlgChk}"/>  />
							<span class="label">벤처기업</span>
						</label>

						<label class="label_form" for="tecnlg2">
							<input type="checkbox" class="form_checkbox" name="tecnlg2" id="tecnlg2" value="Y" onClick="tecnlgCheck('true')" <c:out value="${tecnlgChk2}"/>>
							<span class="label">이노비즈기업</span>
						</label>

						<label class="label_form" for="tecnlg3">
							<input type="checkbox" class="form_checkbox" name="tecnlg3" id="tecnlg3" value="Y" onClick="tecnlgCheck('true')" <c:out value="${tecnlgChk2}"/>>
							<span class="label">유망중소기업</span>
						</label>

						<label class="label_form" for="tecnlg4">
							<input type="checkbox" class="form_checkbox" name="tecnlg4" id="tecnlg4" value="Y" onClick="tecnlgCheck('none')" <c:out value="${tecnlgChk4}"/>>
							<span class="label">해당없음</span>
						</label>

						<span class="append">(신청일 현재 유효기일 내의 것에 한함)</span>
					</div>
				</td>
			</tr>
			<tr>
				<th colspan="2">국내외특허증/인증서<br/>&nbsp;(최근 3년이내)</th>
				<td colspan="3">
					<div class="form_row">
						<label class="label_form">
							<input type="radio" class="form_radio" name="indsPropYn" value="Y" onclick="indsPropRadio('yes')"  <c:out value="${indsPropYn1}"/>  />
							<span class="label">있음</span>
						</label>

						<label class="label_form">
							<input type="radio" class="form_radio" name="indsPropYn" value="N" onclick="indsPropRadio('none')"  <c:out value="${indsPropYn2}"/>  />
							<span class="label">없음</span>
						</label>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<input type="text" class="form_text align_r mr-3" style="width: 100px; min-width: 100px;" id="indsPropCnt" name="indsPropCnt" value="<c:out value="${fundVo.indsPropCnt}"/>" <c:out value="${indsPropReadonly}"/>  maxlength="4" title="국내외특허증/인증서" /> ) 개
			...
			<tr style="display:none;">
				...
				<td colspan="3"">
						<select id="targetnationCd" name="targetnationCd" class="form_select" >
							<c:forEach var="item" items="${JCS002}" varStatus="status">
								<option value="<c:out value="${item.detailcd}"/>" <c:if test="${item.detailcd eq fundVo.targetnationCd}">selected="selected"</c:if>><c:out value="${item.detailnm}"/></option>
							</c:forEach>
						</select>
				</td>
			</tr>
			...
			<tr>
				...
				<th>자금신청액<br/>
					&nbsp;(신청한도: <fmt:formatNumber value="${amountMax.amountMax}" />원)
				</th>
				<td>
					<div class="form_row">
						<input type="text" class="form_text align_r" id="necessAmount" name="necessAmount" value="<c:out value="${fundVo.necessAmount}"/>" style="width: 80%" maxlength="13" title="자금신청액"
						onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" /> <span class="append">(원)</span>
					</div>
				</td>
			</tr>
...
<c:choose>
	...
	<!-- 201703 보다 크다 'Y'  -->
		...
		<table class="formTable" id="planTable">
			<colgroup>
				<col width="7.5%">
				<col width="15%">
				<col width="15%">
			...
			<tr>
				<th rowspan="13" align="left">(19)<br/>&nbsp;자금사용계획</th>
	...
	<!--  2023년 부터 해당 내용    -->
			<tr>
				...
				<td align="right" >
					<input type="text" class="form_text align_r" id="plancd11amt" name="plancd11amt" value="<c:out value="${fundVo.plancd11amt}"/>" style="width: 100%" maxlength="13" title="국내 외 전시/박람회 참가 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planNewAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd1Nationitem" name="plancd1Nationitem" value="<c:out value="${fundVo.plancd1Nationitem}"/>" style="width: 100%" maxlength="95" title="국내 외 전시/박람회 참가 대상국가 및 품목" />
				</td>
			</tr>
			...
			<th>수출상담회 참가 및 바이어 초청</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd21amt" name="plancd21amt" value="<c:out value="${fundVo.plancd21amt}"/>" style="width: 100%" maxlength="13" title="수출상담회 참가 및 바이어 초청 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planNewAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd2Nationitem" name="plancd2Nationitem" value="<c:out value="${fundVo.plancd2Nationitem}"/>" style="width: 100%" maxlength="95" title="수출 상담회 참가 대상국가 및 품목" />
				</td>
			</tr>

			<tr>
				<th>해외 특허 획득 및 규격인증 획득</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd51amt" name="plancd51amt" value="<c:out value="${fundVo.plancd51amt}"/>" style="width: 100%" maxlength="13" title="해외 특허 획득 및 규격인증 획득 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planNewAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd5Nationitem" name="plancd5Nationitem" value="<c:out value="${fundVo.plancd5Nationitem}"/>" style="width: 100%" maxlength="95" title="해외 특허 획득 및 규격인증 획득 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>해외 홍보 및 시장조사</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd71amt" name="plancd71amt" value="<c:out value="${fundVo.plancd71amt}"/>" style="width: 100%" maxlength="13" title="해외 홍보 및 시장조사 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planNewAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd7Nationitem" name="plancd7Nationitem" value="<c:out value="${fundVo.plancd7Nationitem}"/>" style="width: 100%" maxlength="95" title="해외 홍보 및 시장조사 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				...
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd101amt" name="plancd101amt" value="<c:out value="${fundVo.plancd101amt}"/>" style="width: 100%" maxlength="13" title="수출용 원자재/완제품 구매 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planNewAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd10Nationitem" name="plancd10Nationitem" value="<c:out value="${fundVo.plancd10Nationitem}"/>" style="width: 100%" maxlength="95" title="수출용 원자재/완제품 구매 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>기타(물류비지원)</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd91amt" name="plancd91amt" value="<c:out value="${fundVo.plancd91amt}"/>" style="width: 100%" maxlength="13" title="기타 예상소요금액"
				...
				<td>
					<input type="text" class="form_text " id="plancd9Nationitem" name="plancd9Nationitem" value="<c:out value="${fundVo.plancd9Nationitem}"/>" style="width: 100%" maxlength="95" title="기타 대상국가 및 품목" />
				</td>
			</tr>
	</c:if>
	...
	<!--  2022년 까지 해당 내용    -->
			...
			<tr>
				<th>수출 상담회 참가</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd21amt" name="plancd21amt" value="<c:out value="${fundVo.plancd21amt}"/>" style="width: 100%" maxlength="13" title="수출 상담회 참가 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd2Nationitem" name="plancd2Nationitem" value="<c:out value="${fundVo.plancd2Nationitem}"/>" style="width: 100%" maxlength="95" title="수출 상담회 참가 대상국가 및 품목" />
			...
			<tr>
				<th>바이어 초청</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd31amt" name="plancd31amt" value="<c:out value="${fundVo.plancd31amt}"/>" style="width: 100%" maxlength="13" title="바이어 초청 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd3Nationitem" name="plancd3Nationitem" value="<c:out value="${fundVo.plancd3Nationitem}"/>" style="width: 100%" maxlength="95" title="바이어 초청 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>바이어 방문</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd41amt" name="plancd41amt" value="<c:out value="${fundVo.plancd41amt}"/>" style="width: 100%" maxlength="13" title="바이어 방문 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd4Nationitem" name="plancd4Nationitem" value="<c:out value="${fundVo.plancd4Nationitem}"/>" style="width: 100%" maxlength="95" title="바이어 방문 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>해외 특허 획득</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd51amt" name="plancd51amt" value="<c:out value="${fundVo.plancd51amt}"/>" style="width: 100%" maxlength="13" title="해외 특허 획득 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd5Nationitem" name="plancd5Nationitem" value="<c:out value="${fundVo.plancd5Nationitem}"/>" style="width: 100%" maxlength="95" title="해외 특허 획득 대상국가 및 품목" />
				</td>
			</tr>
			<tr>
				<th>해외 규격인증 획득</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd61amt" name="plancd61amt" value="<c:out value="${fundVo.plancd61amt}"/>" style="width: 100%" maxlength="13" title="해외 규격인증 획득 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd6Nationitem" name="plancd6Nationitem" value="<c:out value="${fundVo.plancd6Nationitem}"/>" style="width: 100%" maxlength="95" title="해외 규격인증 획득 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>해외 홍보</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd71amt" name="plancd71amt" value="<c:out value="${fundVo.plancd71amt}"/>" style="width: 100%" maxlength="13" title="해외 홍보 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd7Nationitem" name="plancd7Nationitem" value="<c:out value="${fundVo.plancd7Nationitem}"/>" style="width: 100%" maxlength="95" title="해외 홍보 대상국가 및 품목" />
				</td>
			</tr>
			<tr>
				<th>해외 시장조사</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd81amt" name="plancd81amt" value="<c:out value="${fundVo.plancd81amt}"/>" style="width: 100%" maxlength="13" title="해외 시장조사 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd8Nationitem" name="plancd8Nationitem" value="<c:out value="${fundVo.plancd8Nationitem}"/>" style="width: 100%" maxlength="95" title="해외 시장조사 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>수출용 원자재 수입</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="plancd111amt" name="plancd111amt" value="<c:out value="${fundVo.plancd111amt}"/>" style="width: 100%" maxlength="13" title="수출용 원자재 수입 예상소요금액"
					onfocus="doNumberFloatFocusEvent(this);" onblur="doNumberFloatBlurEvent(this);" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
				</td>
				<td>
					<input type="text" class="form_text " id="plancd11Nationitem" name="plancd11Nationitem" value="<c:out value="${fundVo.plancd11Nationitem}"/>" style="width: 100%" maxlength="95" title="수출용 원자재 수입 대상국가 및 품목" />
				</td>
			</tr>
			...
			<tr>
				<th>합계</th>
				<td align="right">
					<input type="text" class="form_text align_r" id="sumPlancd1amt" name="sumPlancd1amt" readonly="readonly" value="<c:out value="${fundVo.sumPlancd1amt}"/>" style="width: 100%" maxlength="13" title="합계" />
				</td>

				<td>
				<span style="display: none;">
					<input type="text" class="form_text align_r" id="plancd12amt" name="plancd12amt" value="<c:out value="${fundVo.plancd12amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd22amt" name="plancd22amt" value="<c:out value="${fundVo.plancd22amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd32amt" name="plancd32amt" value="<c:out value="${fundVo.plancd32amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd42amt" name="plancd42amt" value="<c:out value="${fundVo.plancd42amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd52amt" name="plancd52amt" value="<c:out value="${fundVo.plancd52amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd62amt" name="plancd62amt" value="<c:out value="${fundVo.plancd62amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd72amt" name="plancd72amt" value="<c:out value="${fundVo.plancd72amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd82amt" name="plancd82amt" value="<c:out value="${fundVo.plancd82amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd102amt" name="plancd102amt" value="<c:out value="${fundVo.plancd102amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd112amt" name="plancd112amt" value="<c:out value="${fundVo.plancd112amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="plancd92amt" name="plancd92amt" value="<c:out value="${fundVo.plancd92amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" onchange='planAmtSum(this)' />
					<input type="text" class="form_text align_r" id="sumPlancd2amt" name="sumPlancd2amt" value="<c:out value="${fundVo.sumPlancd2amt}"/>" style="width: 100%" maxlength="13" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
				</span>
...
<script type="text/javascript">
	...
	function getList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/ssm/applicationSelectionHistoryList.do" />'
...
// 		var url = f.listPage.value;
		...
		if($('#gubun').val() == 'appl') {
			url = '/tfms/ssm/applicationList.do';
		}

		if($('#gubun').val()  == 'selection'){
			url = '/tfms/ssm/applicationSelectionList.do';
		}
		f.action = url;
		f.target = "_self";
		f.method = "post";
	...
	function doPrint(){
		...
		if ( svrId != "" && applyId !="" && bsNo !=""  ){
			...
			if ( profile == "local" || profile == "dev"    ){
				strUrl = "https://devmembership.kita.net/fai/fund/popup/fundInquiryPrint.do?";
			}else{
				strUrl = "https://membership.kita.net/fai/fund/popup/fundInquiryPrint.do?";
			}
...
/* 		global.openLayerPopup({
			popupUrl : '<c:url value="/tfas/popup/fundInquiryPrintPopup.do" />'		///tfas/popup/FundInquiryPrintPopup.screen
			, params : {
				 svrId 	 : f.svrId.value
	...
	function doSave(){
		...
		var v_ten_million = parseFloat(f.expAmount1.value.replace(/,/gi ,""))	+ parseFloat(f.omisExpAmount1.value.replace(/,/gi ,""));
		if(st_val == '03' && v_ten_million > 20000000){
		...
		var necessAmount = $('#necessAmount').val().replace(/,/gi ,"");
		var amountMax = $("#amountMax").val().replace(/,/gi ,"");

		if ( parseFloat(necessAmount) > parseFloat(amountMax)  ){
			alert('신청한도를 초과 하였습니다.');
			$('#necessAmount').focus();
			return ;
		}
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/ssm/applicationSelectionSaveData.do" />'
			, data : $('#form1').serialize()
			, dataType : 'json'
			, async : true
			, spinner : true
	...
	//신청업체선정 상세
	function goLocation(){
		var url = "/tfms/ssm/applicationSelection.do";
	...
	function doSaveAddr(){
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/ssm/applicationSelectionSaveDataAddr.do" />'
			, data : $('#form1').serialize()
			, dataType : 'json'
			, async : true
			, spinner : true
	...
	function doSaveCancel(){
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/ssm/applicationSelectionSaveDataCancel.do" />'
			, data : $('#form1').serialize()
			, dataType : 'json'
			, async : true
			, spinner : true
	...
	function goApplicationSelect(Row){
		...
		var url = '<c:url value="/tfms/ssm/applicationSelection.do" />';
