...
<script type="text/javascript">
	...
	function doSave(){
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/jcs/saveJudgingCriteriaSettingSpeList.do" />'
	...
	function getList() {
		...
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/jcs/selectJudgingCriteriaSettingSpeList.do" />'
	...
	function doMake() {
		...
		if (confirm('선택한 기준년월에 대한 심사기준을 생성하시겠습니까?\n\n 마지막 심사기준에 해당하는 심사기준을 생성 합니다.')) {
			global.ajax({
				type : 'POST'
				, url : '<c:url value="/tfms/jcs/saveJudgingCriteriaSettingMakeSpe.do" />'
				, dataType : 'json'
	...
	function doDelete() {
		if (confirm('해당 심사기준년월 데이터를 삭제 합니다.')) {
			global.ajax({
				type : 'POST'
				, url : '<c:url value="/tfms/jcs/deleteJudgingCriteriaSettingSpe.do" />'
				, dataType : 'json'
