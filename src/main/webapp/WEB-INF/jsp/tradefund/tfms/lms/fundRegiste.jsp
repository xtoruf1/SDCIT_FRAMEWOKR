		...
		<div class="cont_block">
			...
			<table class="formTable" id="subTable">
				...
				<tr>
					...
					<td >
						<input type="text" class="form_text" placeholder="무역기금 융자명" title="무역기금 융자명" id="title" name="title" style="width: 99%" maxlength="150" required="required" />
					</td>
				</tr>
				<!-- <tr>
					<th rowspan="2">무역기금융자<br> 세부내용 <strong class="point">*</strong></th>
					<td colspan="2">
						<textarea rows="10" class="form_textarea" id="bodyDesc" name="bodyDesc" placeholder="무역기금융자 세부내용" title="무역기금융자 세부내용" style="height:99%; width:99%" required="required"
						onKeyUp="textareachk(this)" onFocus="JavaScript:inputTextOnFocus(this);"  onBlur="JavaScript:inputTextOutFocus(this);" ></textarea>
					</td>
				</tr>
				<tr>
		            <td colspan="2">
				...
				<tr>
					...
					<td>
						<span class="form_search" style="width: 200px;">
							...
							<input type="text" class="form_text" placeholder="이름" title="이름" id="regEmpNm" name="regEmpNm" maxlength="100" readonly="readonly" required="required" />
...
<!-- 				</tr> -->
				<tr>
					...
					<td >
						<input type="hidden" id="bsnStartDt" name="bsnStartDt" />
						<input type="hidden" id="bsnEndDt" name="bsnEndDt" />
						<!-- datepicker -->
						<div class="datepicker_box">
							<span class="form_datepicker">
				...
				<tr>
					<th>1차 지급일 <strong class="point">*</strong></th>
					<td>
						<div class="flex align_center">
							<div class="form_row" style="min-width:100px;">
								<input type="text" class="form_text align_ctr" title="융자 1차 지급월" id="fund1Mm" name="fund1Mm" size="2" maxlength="2" required="required" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
								<span class="append">월</span>
							</div>
							<div class="form_row" style="min-width:100px;">
								<input type="text" class="form_text align_ctr" title="융자 1차 지급일" id="fund1Dd" name="fund1Dd" size="2" maxlength="2" required="required" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
								<span class="append">일</span>
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td>
						<div class="flex align_center">
							<div class="form_row" style="min-width:100px;">
								<input type="text" class="form_text align_ctr" title="융자 2차 지급월" id="fund2Mm" name="fund2Mm" size="2" maxlength="2" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
								<span class="append">월</span>
							</div>
							<div class="form_row" style="min-width:100px;">
								<input type="text" class="form_text align_ctr" title="융자 2차 지급일" id="fund2Dd" name="fund2Dd" size="2" maxlength="2" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
								<span class="append">일</span>
							</div>
						</div>
					</td>
				...
				<tr>
					...
					<td >
						<div class="flex align_center">
							<div class="form_row" style="min-width:100px;">
								<input type="text" class="form_text align_ctr" title="융자 3차 지급월" id="fund3Mm" name="fund3Mm" size="2" maxlength="2" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
								<span class="append">월</span>
							</div>
							<div class="form_row" style="min-width:100px;">
								<input type="text" class="form_text align_ctr" title="융자 3차 지급일" id="fund3Dd" name="fund3Dd" size="2" maxlength="2" onkeypress="doKeyPressEvent(this, 'NUMBER', event)" />
								<span class="append">일</span>
							</div>
						</div>
					</td>
...
<script type="text/javascript">
	...
	function initIBSheet(){
		...
		createIBSheet2(container, sheetId, "100%", "661px");
	...
	//조회
	function doSearch() {
		//sheet1.ColumnSort(""); 조회시 sort 초기화
		getList();
	}
	...
	function getList() {
		global.ajax({
			type : 'POST'
			, url : '<c:url value="/tfms/lms/selectFundRegisteList.do" />'
	...
	function doSave(){
		...
		$('#bsnStartDt').val($('#bsnAplStartDt').val());
		$('#bsnEndDt').val($('#bsnAplEndDt').val());
		...
		if (flag){
			global.ajaxSubmit($('#form1'), {
				type : 'POST'
				, url : '<c:url value="/tfms/lms/saveFundRegiste.do" />'
	...
	function doDelete(){
		...
		f.statusChk.value = 'D';
 		...
 		global.ajaxSubmit($('#form1'), {
			type : 'POST'
			, url : '<c:url value="/tfms/lms/deleteFundRegiste.do" />'
			, enctype : 'multipart/form-data'
			, dataType : 'json'
			, async : false
			, spinner : true
