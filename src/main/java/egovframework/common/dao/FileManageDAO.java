...
public class FileManageDAO extends CommonDAO {
...
//	public void insertFileInfsMyFile(List<?> fileList) throws Exception {
//		MyFileVO vo = (MyFileVO) fileList.get(0);
//		Iterator<?> iter = fileList.iterator();
//		while (iter.hasNext()) {
//			vo = (MyFileVO) iter.next();
//
//			insert("MyFileSQL.insertMyFile", vo);
//		}
//	}
