...
public class NumberUtil {
	 ...
	 * @return
	 */
	public static Long numberObjectToLong(Object param) {
		if (param.getClass().toString().contains("BigDecimal")) {
			return ((BigDecimal)param).longValue();
		} else if (param.getClass().toString().contains("BigInteger")) {
			return ((BigInteger)param).longValue();
		} else if (param.getClass().toString().contains("Integer")) {
			return Long.valueOf((Integer)param);
		} else if (param.getClass().toString().contains("Long")) {
			return (Long)param;
		} else if (param.getClass().toString().contains("String")) {
	 ...
	 * @return
	 */
	public static Integer numberObjectToInteger(Object param) {
		if (param.getClass().toString().contains("BigDecimal")) {
			return ((BigDecimal)param).intValue();
		} else if (param.getClass().toString().contains("BigInteger")) {
			return ((BigInteger)param).intValue();
		} else if (param.getClass().toString().contains("Integer")) {
			return Integer.valueOf((Integer)param);
		} else if (param.getClass().toString().contains("Long")) {
